...
class Style extends AnpsFramework {
    ...
    public function all_fonts() {  
        ...
        foreach($fonts['Google fonts'] as $key => $item) {
            if($item['name'] == 'Montserrat') {
                $fonts['Google fonts'][$key+1] = array('value' => 'Montserrat+Light', 'name' => 'Montserrat Light', 'subsets' => array('latin', 'vietnamese', 'latin-ext'));
            }     
        }
        return $fonts;
    }   
    ...
    public function save() { 
        ...
        header("Location: themes.php?page=theme_options&sub_page=font_options");
    }
