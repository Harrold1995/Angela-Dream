...
class AnpsSocial extends WP_Widget {
    public function __construct() {
        parent::__construct(
                'AnpsSocial', __('AnpsThemes - Social icons', 'hairdresser'), array('description' => __('Enter social icons to show on page', 'hairdresser'),)
        );
    ...
    function form($instance) {
        ...
        <p>
            ...
            <label for="<?php echo esc_attr($this->get_field_id('sidebar_content')); ?>"><?php _e("Sidebar content", 'hairdresser'); ?></label>
        </p>

        <p>
            <label for="<?php echo esc_attr($this->get_field_id('target')); ?>"><?php _e("Target", 'hairdresser'); ?></label>
                    ...
                    <p>
                        ...
                        <?php
                            ...
                            if (strpos($social_icon, 'fa-') !== false)  {
                                ...
                                $social_icon = str_replace('fa-fa-', 'fa-', $social_icon);
                            }
    ...
    function widget($args, $instance) {
        ...
        <ul class="<?php echo esc_attr($class); ?>">
            ...
            <li>
                <?php if($social_url!="") : ?>
                <a<?php echo wp_kses_post($title_attribute); ?> href="<?php echo esc_url($social_url); ?>" target="<?php echo esc_attr($target); ?>"<?php if(isset($instance['icon_color'])&&$instance['icon_color']!=''):?> style="color: <?php echo esc_attr($instance['icon_color']);?>"<?php endif; ?>>
                <?php if (strpos($social_icon, 'anps-') !== false): ?>
                     <span class="fa"><?php echo anps_svg(str_replace('anps-icon-', '', $social_icon)); ?></span>
                <?php else: ?>
                    <i class="fa <?php echo esc_attr($social_icon); ?>" aria-hidden="true"></i>
                <?php endif; ?>

                <span class="sr-only"><?php echo wp_kses_post($social_title); ?></span>
                </a>
                <?php else : ?>
