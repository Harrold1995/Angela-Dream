...
class AnpsText extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
            'AnpsText', __('AnpsThemes - Text and icon', 'hairdresser'), array('description' => __('Enter text and/or icon to show on page. Can only be used in the Top bar widget areas.', 'hairdresser'),)
        );
    ...
    function form($instance) {
        ...
        <!-- Title color -->
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('title_color')); ?>"><?php _e("Title color", 'hairdresser'); ?></label><br />
            <input class="anps-color-picker" id="<?php echo esc_attr($this->get_field_id('title_color')); ?>" name="<?php echo esc_attr($this->get_field_name('title_color')); ?>" type="text" value="<?php echo esc_attr($instance['title_color']); ?>" />
        </p>
        <!-- Subtitle color -->
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('subtitle_color')); ?>"><?php _e("Subtitle color", 'hairdresser'); ?></label><br />
            <input class="anps-color-picker" id="<?php echo esc_attr($this->get_field_id('subtitle_color')); ?>" name="<?php echo esc_attr($this->get_field_name('subtitle_color')); ?>" type="text" value="<?php echo esc_attr($instance['subtitle_color']); ?>" />
        </p>
        <!-- Title -->
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php _e("Title", 'hairdresser'); ?></label><br />
        ...
        <!-- Subtitle -->
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('subtitle')); ?>"><?php _e("Subtitle", 'hairdresser'); ?></label><br />
    ...
    function widget($args, $instance) {
        ...
        <?php if($icon != 'fa-'): ?>
            <?php if (strpos($icon, 'anps-') !== false): ?>
                <span class="fa" <?php echo esc_attr($icon);?>"<?php if($icon_color!=''):?> style="color: <?php echo esc_attr($icon_color);?>"<?php endif; ?>><?php echo file_get_contents(get_template_directory_uri() . '/images/svgs/' . str_replace('anps-icon-', '', $icon) . '.svg'); ?></span>
            <?php else: ?>
        ...
        <?php if($title != ''): ?>
            <span class="anpstext-desc"<?php if($subtitle_color!=''):?> style="color: <?php echo esc_attr($subtitle_color);?>"<?php endif; ?>>
                <span class="important"<?php if($title_color!=''):?> style="color: <?php echo esc_attr($title_color);?>"<?php endif; ?>><?php echo wp_kses_post($title); ?></span>
                <?php if($subtitle !== ''): ?>
                    <br />
        ...
        <?php else: ?>
            <span class="anpstext-desc"><?php echo wp_kses_post($text); ?></span>
        <?php endif;
