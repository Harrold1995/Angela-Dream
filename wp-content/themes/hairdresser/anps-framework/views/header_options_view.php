    ...
    <div class="content-inner">
        ...
        <div class="input fullwidth" id="headerstyle">
            <?php
                ...
                $images_array = array(
                    ...
                    'full-length-menu',
                    'boxed-menu',
                    'top-background-menu-modern',
                    'top-transparent-menu-modern',
                );
        ...
        <div class="anps_menu_type_font fullwidth ">
            <div class="input onethird onoff head-1 head-3" >
                <label for="anps_front_text_color"><?php esc_html_e("Transparent text color", 'hairdresser'); ?></label>
            ...
            <div class="input onethird onoff head-1 head-3" >
                <label for="anps_front_text_hover_color"><?php esc_html_e("Transparent text hover color", 'hairdresser'); ?></label>
            ...
            <div class="input onethird onoff head-1 head-3">
                <label for="anps_front_curent_menu_color"><?php esc_html_e('Transparent selected main menu color', 'hairdresser'); ?></label>
            ...
            <div class="onoff input head-2 head-4 head-5 head-6 head-7 head-8 onethird" >
            ...
            <div class="onoff input head-1 head-3 onethird" >
                <label for="anps_front_topbar_color"><?php esc_html_e("Transparent top bar color", 'hairdresser'); ?></label>
            ...
            <div class="onoff input head-1 head-3 onethird" >
                <label for="anps_front_topbar_bg_color"><?php esc_html_e('Transparent top bar background color', 'hairdresser'); ?></label>
            ...
            <div class="onoff input head-1 head-3 onethird" >
                <label for="anps_front_topbar_hover_color"><?php esc_html_e("Transparent top bar link hover color", 'hairdresser'); ?></label>
            ...
            <div class="onoff input head-5 head-6 onethird">
                <label for="anps_large_above_menu_style"><?php esc_html_e('Large above menu style', 'hairdresser'); ?></label>
                <select name="anps_large_above_menu_style" id="anps_above_nav_bar">
                    <?php $items = array(
                        ...
                        '4' => esc_html__('Style 4', 'hairdresser'),
                        '5' => esc_html__('Style 5', 'hairdresser')
                    );
            ...
            <!-- Above menu height -->
            <div class="onoff input head-5 head-6 onethird">
                <label for='anps_above_menu_height'><?php esc_html_e('Above menu height in pixels', 'hairdresser'); ?></label>
                <input type='text' value='<?php echo get_option('anps_above_menu_height', ''); ?>' name='anps_above_menu_height' id='anps_above_menu_height' />
            </div>

            <div class="onethird input onoff head-6 head-7 head-8">
                <label for="anps_menu_button"><?php esc_html_e('Menu button', 'hairdresser'); ?></label>
            ...
            <div class="onethird input onoff head-6 head-7 head-8">
                <label for="anps_menu_button_text"><?php esc_html_e('Menu button text', 'hairdresser'); ?></label>
                <input type="text" name="anps_menu_button_text" id="anps_menu_button_text" value="<?php echo get_option('anps_menu_button_text', ''); ?>" />
            </div>
            <div class="onethird input onoff head-6 head-7 head-8">
                <label for="anps_menu_button_url"><?php esc_html_e('Menu button url', 'hairdresser'); ?></label>
        ...
        <div class="input onequarter">
            <label for="anps_topmenu_style"><?php esc_html_e("Display top bar?", 'hairdresser'); ?></label>
        ...
        <!-- Top bar height -->
        <div class='input onequarter'>
            <label for='anps_top_bar_height'><?php esc_html_e('Top bar height in pixels', 'hairdresser'); ?></label>
            <input type='text' value='<?php echo get_option('anps_top_bar_height', '60'); ?>' name='anps_top_bar_height' id='anps_top_bar_height' />
        </div>
        <!-- Top bar divider -->
        <div class="input onequarter">
            <?php
            $checked = get_option('anps_top_bar_divider', '') != '' ? ' checked' : '';
            ?>
            <label for="anps_top_bar_divider"><?php esc_html_e("Top bar divider", 'hairdresser'); ?></label>
            <input type="hidden" value="" name="anps_top_bar_divider"/>
            <input id="anps_top_bar_divider" value="1" class="small_input" type="checkbox" name="anps_top_bar_divider"<?php echo esc_attr($checked); ?> />
        </div>
        <div class="input onequarter">
        ...
        <div class="input onequarter">
            <label for="anps_menu_style"><?php esc_html_e("Menu", 'hairdresser'); ?></label>
            <select name="anps_menu_style" id="anps_menu_style">
                    <?php $pages = array("1"=>esc_html__('Normal', 'hairdresser'), "2"=>esc_html__('Description', 'hairdresser'));
                    foreach ($pages as $key => $item) :
                        $selected = '';
        ...
        <div class="input onequarter">
            <?php
            $checked = '';
            if(anps_get_option('', '', 'menu_center') != '') {
                $checked = ' checked';
            }
            ?>
            <label for="anps_menu_center"><?php esc_html_e("Menu centered", 'hairdresser'); ?></label>
            <input type="hidden" value="" name="anps_menu_center"/>
            <input id="anps_menu_center" value="1" class="small_input" style="margin-left: 37px" type="checkbox" name="anps_menu_center"<?php echo esc_attr($checked); ?> />
        </div>
        <!-- Sticky menu -->
        <div class="input onequarter">
            <?php
            ...
            ?>
            <label for="anps_sticky_menu"><?php esc_html_e("Sticky menu", 'hairdresser'); ?></label>
        ...
        <div class="input onequarter">
            <label for="anps_search_style"><?php esc_html_e("Search style", 'hairdresser'); ?></label>
            <select name="anps_search_style" id="anps_search_style">
                <?php
                $pages = array(
                    "default" => esc_html__('Default', 'hairdresser'),
                    "minimal" => esc_html__('Minimal', 'hairdresser')
                );
        ...
        <div class="input onequarter">
            ...
            ?>
            <label for="anps_search_icon"><?php esc_html_e("Display search icon in menu (desktop)?", 'hairdresser'); ?></label>
        ...
        <div class="input onequarter">
            ...
            ?>
            <label for="anps_search_icon_mobile"><?php esc_html_e("Display search on mobile and tablets?", 'hairdresser'); ?></label>
        ...
        <!-- Enable walker -->
        <div class="input onequarter">
            <label for="anps_global_menu_walker"><?php esc_html_e('Enable menu walker (mega menu)', 'hairdresser'); ?></label>
        ...
        <div class="input onequarter">
            <label for="anps_logo_background"><?php esc_html_e('Display background color behind logo', 'hairdresser'); ?></label>
        ...
        <div class="clear"></div>
        <!-- Main menu settings -->
        <h3><?php esc_html_e('Main menu settings', 'hairdresser'); ?></h3>
        <div class='input onequarter'>
            <label for='anps_main_menu_height'><?php esc_html_e('Main menu height in pixels', 'hairdresser'); ?></label>
            <input type='text' value='<?php echo get_option('anps_main_menu_height', ''); ?>' name='anps_main_menu_height' id='anps_main_menu_height' />
        </div>
        <div class="input onequarter">
            <label for="anps_main_menu_selection"><?php esc_html_e('Dropdown selection states', 'hairdresser'); ?></label>
            <select id="anps_main_menu_selection" name="anps_main_menu_selection">
                <option value="0"<?php if(get_option('anps_main_menu_selection', '0')=='0'){echo ' '.esc_attr('selected');}?>><?php esc_html_e('Hover color & bottom border', 'hairdresser'); ?></option>
                <option value="1"<?php if(get_option('anps_main_menu_selection', '0')=='1'){echo ' '.esc_attr('selected');}?>><?php esc_html_e('Hover color', 'hairdresser'); ?></option>
            </select>
        </div>
        <div class="input onequarter">
            <label for="anps_dropdown_style"><?php esc_html_e('Dropdown style', 'hairdresser'); ?></label>
            <select id="anps_dropdown_style" name="anps_dropdown_style">
                <option value="1"<?php if(get_option('anps_dropdown_style', '1')=='1'){echo ' '.esc_attr('selected');}?>><?php esc_html_e('Normal', 'hairdresser'); ?></option>
                <option value="2"<?php if(get_option('anps_dropdown_style', '1')=='2'){echo ' '.esc_attr('selected');}?>><?php esc_html_e('Dividers', 'hairdresser'); ?></option>
                <option value="3"<?php if(get_option('anps_dropdown_style', '1')=='3'){echo ' '.esc_attr('selected');}?>><?php esc_html_e('Dividers style 2', 'hairdresser'); ?></option>
                <option value="4"<?php if(get_option('anps_dropdown_style', '1')=='4'){echo ' '.esc_attr('selected');}?>><?php esc_html_e('Modern', 'hairdresser'); ?></option>
            </select>
        </div>
        <!-- Sticky menu -->
        <div class="input onequarter">
            ...
            ?>
            <label for="anps_menu_dividers"><?php esc_html_e("Menu dividers", 'hairdresser'); ?></label>
