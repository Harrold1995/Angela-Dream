...
$footer_class = "2";
$footer_style = get_option('anps_footer_widget_style', 'default');
$footer_style_class = 'site-footer--' . $footer_style;
...
<footer class="site-footer <?php echo esc_attr($footer_style_class);?>">
    ...
    <?php endif; ?>
    <?php if($footer_disable!="on" && $footer_disable!="1" && (is_active_sidebar('footer-1') || is_active_sidebar('footer-2') || is_active_sidebar('footer-3') || is_active_sidebar('footer-4'))) : ?>
    <div class="container">
        <div class="row">
            ...
            <?php elseif($footer_columns=='5') : ?>
                <div class="col-md-3 <?php echo esc_attr($footer_class); ?>"><ul><?php dynamic_sidebar( 'footer-1' ); ?></ul></div>
                <div class="col-md-9 footer-right <?php echo esc_attr($footer_class); ?>"><ul><?php dynamic_sidebar( 'footer-2' ); ?></ul></div>
            <?php elseif($footer_columns=='6') : ?>
                <div class="col-md-9 <?php echo esc_attr($footer_class); ?>"><ul><?php dynamic_sidebar( 'footer-1' ); ?></ul></div>
                <div class="col-md-3 <?php echo esc_attr($footer_class); ?>"><ul><?php dynamic_sidebar( 'footer-2' ); ?></ul></div>
            <?php endif; ?>
	</div>
    </div>
